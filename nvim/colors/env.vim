...
" GENERAL
" ------------------------------------------------------------------------- {{{
call MyHL('Boolean', $COLOR_LIGHT_MAGENTA, '', '')
call MyHL('Character', $COLOR_LIGHT_YELLOW, '', '')
hi link Number Boolean
hi link String Character
call MyHL('Conditional', $COLOR_MAGENTA, '', 'bold')
call MyHL('Constant', $COLOR_LIGHT_MAGENTA, '', 'bold')
...
call MyHL('Error', $COLOR_LIGHT_YELLOW, $COLOR_BLACK, '')
call MyHL('ErrorMsg', $COLOR_MAGENTA, $COLOR_BLACK, 'bold')
call MyHL('Exception', $COLOR_GREEN, '', 'bold')
call MyHL('Float', $COLOR_CYAN, '', '')
call MyHL('Folded', $COLOR_LIGHT_YELLOW, $COLOR_BLACK, '')
hi link FoldColumn Folded
call MyHL('Function', $COLOR_GREEN, '', '')
call MyHL('Identifier', $COLOR_YELLOW, '', '')
call MyHL('Ignore', $COLOR_DARK_GREY, '', '')
call MyHL('IncSearch', $COLOR_LIGHT_YELLOW, $COLOR_BLACK, '')
call MyHL('Keyword', $COLOR_LIGHT_MAGENTA, '', 'bold')
call MyHL('Label', $COLOR_LIGHT_YELLOW, '', '')
call MyHL('Macro', $COLOR_YELLOW, '', 'italic')
call MyHL('SpecialKey', $COLOR_GREEN, '', 'italic')
call MyHL('MatchParen', $COLOR_LIGHT_YELLOW, $COLOR_BLACK, 'bold')
call MyHL('ModeMsg', $COLOR_LIGHT_YELLOW, '', '')
call MyHL('MoreMsg', $COLOR_LIGHT_YELLOW, '', '')
call MyHL('Operator', $COLOR_LIGHT_MAGENTA, '', '')
call MyHL('Pmenu', $COLOR_LIGHT_GREEN, $COLOR_BLACK, '')
call MyHL('PmenuSel', '', $COLOR_DARK_GREY, '')
call MyHL('PmenuSbar', '', $COLOR_BLACK, '')
call MyHL('PmenuThumb', $COLOR_LIGHT_GREEN, '', '')
...
call MyHL('Search', $COLOR_BLACK, $COLOR_LIGHT_YELLOW, '')
...
call MyHL('Special', $COLOR_LIGHT_GREEN, '', 'italic')
if has('spell')
 call MyHL('SpellBad', $COLOR_RED, '', 'undercurl,bold')
 call MyHL('SpellCap', $COLOR_CYAN, '', 'undercurl,bold')
 call MyHL('SpellLocal', $COLOR_LIGHT_GREEN, '', 'undercurl,bold')
...
call MyHL('WildMenu', $COLOR_LIGHT_GREEN, $COLOR_BLACK, '')
...
call MyHL('CursorLineNr', $COLOR_LIGHT_YELLOW, '', '')
...
call MyHL('goFunction', $COLOR_LIGHT_GREEN, '', 'bold')
call MyHL('goFunctionCall', $COLOR_LIGHT_CYAN, '', 'bold')
"call MyHL('goHexadecimalInt', $COLOR_LIGHT_BLUE, '', '')
call MyHL('goOperator', '#ffffff', '', '')
call MyHL('goPredefinedIdentifiers', $COLOR_LIGHT_MAGENTA, '', 'italic')
call MyHL('goStatement', $COLOR_MAGENTA, '', 'italic,bold')
call MyHL('goType', $COLOR_LIGHT_CYAN, '', 'italic')
...
" Vim
call MyHL('vimGroup', $COLOR_LIGHT_CYAN, '', 'italic')
...
" TeX
call MyHL('texTypeSize', $COLOR_LIGHT_CYAN, '', 'italic')
call MyHL('texTypeStyle', $COLOR_CYAN, '', 'bold')
call MyHL('texStatement', $COLOR_YELLOW, '', 'bold')

" Markdown
call MyHL('markdownBold', $COLOR_LIGHT_YELLOW, '', 'bold')
"call MyHL('markdownCode', $COLOR_LIGHT_WHITE, $COLOR_BLACK, '')
call MyHL('markdownCodeDelimiter', $COLOR_CYAN, '', 'bold')
"call MyHL('markdownError', $COLOR_LIGHT_YELLOW, '', '')
call MyHL('markdownH1', $COLOR_MAGENTA, '', 'bold')
call MyHL('markdownH2', $COLOR_LIGHT_MAGENTA, '', 'bold')
call MyHL('markdownH3', $COLOR_LIGHT_RED, '', 'bold')
call MyHL('markdownItalic', $COLOR_LIGHT_YELLOW, '', 'italic')
"call MyHL('markdownLinkDelimiter', $COLOR_YELLOW, '', '')
call MyHL('markdownLinkText', $COLOR_LIGHT_GREEN, '', 'underline')
call MyHL('markdownListMarker', $COLOR_LIGHT_GREEN, '', 'bold')
...
" dosini
call MyHL('dosiniLabel', $COLOR_LIGHT_CYAN, '', 'italic')

" i3config
call MyHL('i3ConfigFocusWrappingType', $COLOR_GREEN, '', 'bold')
call MyHL('i3ConfigGapStyleKeyword', $COLOR_LIGHT_YELLOW, '', 'italic')
...
" Yaml
call MyHL('yamlBlockCollectionItemStart', $COLOR_LIGHT_YELLOW, '', 'bold')
"call MyHL('yamlBlockMappingKey', $COLOR_GREEN, '', '')

" Muttrc
call MyHL('muttrcColor', $COLOR_LIGHT_CYAN, '', 'italic')

" Toml
call MyHL('tomlTable', $COLOR_LIGHT_GREEN, '', 'bold')
...
call MyHL('UlLine', $COLOR_LIGHT_YELLOW, $COLOR_DARK_GREY, '')
call MyHL('UlLines', $COLOR_LIGHT_CYAN, $COLOR_DARK_GREY, '')
" }}}
